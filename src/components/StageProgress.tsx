                    ...
                    data.map((stage, i) => {
                        return (
                            ...
                            >
                                ...
                                <div className={clsx(
                                    "text-sm font-bold z-20 h-full w-full flex justify-center items-center text-center", 
                                    stage.is_completed ? "text-grayish" : "text-main-color",
                                    !data[i - 1] && "bg-[#4c583e] animate-pulse text-white",
                                    data[i - 1]?.is_completed && "bg-[#4c583e] animate-pulse text-white"
                                )}> 
                                    {i + 1} 
                                </div>
                            </button>
